...
// Created: 9/13/2011 10:41:10 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcskykqjqvz5bd05pjea7z15r_7k3s";
	this.domain="statse.webtrendslive.com";
	this.timezone=-8;
	this.fpcdom=".webtrends.com";
	this.onsitedoms="webtrends.com";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,docx,xlsx";
	this.navigationtag="div,table";
	this.customerfpc="WT.dcsvid";
	...
	this.vtid=this.dcsGetCookie("WT.dcsvid");
}
